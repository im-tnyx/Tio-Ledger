...
3. Build SQLDelight-backed offline persistence.
4. Deliver the Loan Engine as a heavily tested shared module.
5. Add Android, Wear OS, and iOS presentation shells after the core business foundation is stable.
