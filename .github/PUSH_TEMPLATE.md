...
- [ ] Compile shared metadata:
  ```powershell
  .\gradlew.bat :shared:core:compileKotlinMetadata :shared:domain:compileKotlinMetadata :shared:finance-engine:compileKotlinMetadata :shared:analytics:compileKotlinMetadata :shared:notifications:compileKotlinMetadata :shared:application:compileKotlinMetadata :shared:data:compileKotlinMetadata :shared:database:compileKotlinMetadata :shared:bootstrap:compileKotlinMetadata :shared:ui:compileKotlinMetadata --no-daemon --console=plain --stacktrace
  ```
- [ ] Run critical tests:
  ```powershell
  .\gradlew.bat :shared:finance-engine:test :shared:analytics:test :shared:notifications:test :shared:application:test :shared:data:test :shared:bootstrap:test :shared:ui:test --no-daemon --console=plain --stacktrace
  ```
